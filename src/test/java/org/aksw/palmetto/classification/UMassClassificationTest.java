...
public class UMassClassificationTest extends AbstractClassificationTest {
    ...
    public UMassClassificationTest(String coherenceName, double coherence, int numberOfWords, boolean isGood) {
