...
public class NPMIClassificationTest extends AbstractClassificationTest {
    ...
    public NPMIClassificationTest(String coherenceName, double coherence, int numberOfWords, boolean isGood) {
