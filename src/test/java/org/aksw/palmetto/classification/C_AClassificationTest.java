...
public class C_AClassificationTest extends AbstractClassificationTest {

    private static final String COHERENCE_NAME = "C_A";
    ...
    public static Collection<Object[]> data() {
        return Arrays.asList(new Object[][] {
                ...
                // { COHERENCE_NAME, 0.198670227, 5, Boolean.TRUE }, false negative
                ...
                // { COHERENCE_NAME, 0.1745578069, 10, Boolean.TRUE }, false negative
                ...
                // { COHERENCE_NAME, 0.3124152609, 10, Boolean.TRUE } false negative
        });
    }

    public C_AClassificationTest(String coherenceName, double coherence, int numberOfWords, boolean isGood) {
