...
public class UCIClassificationTest extends AbstractClassificationTest {
    ...
    public UCIClassificationTest(String coherenceName, double coherence, int numberOfWords, boolean isGood) {
